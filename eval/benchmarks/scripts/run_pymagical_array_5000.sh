#!/bin/bash
#SBATCH --mem=512G
#SBATCH --output=eval/benchmarks/logs/py_numba_array_%A_%a.out
#SBATCH --job-name=py_magical_array
#SBATCH --array=0-6
...
OUTDIR="/mnt/home/agebrain/ceph/anderson/snmulti_data/processed/magical/outputs/$CELLTYPE"
